package com.example.juanc.parkinglotdemo4.Location;
...
public class LocationTracker extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener  {
    ...
    public void onLocationChanged(Location location) {
        ...
        //TODO here is where the location is at
        Toast.makeText(this, String.valueOf(location.getLatitude()), Toast.LENGTH_LONG);
        Toast.makeText(this, String.valueOf(location.getLongitude()), Toast.LENGTH_LONG);
